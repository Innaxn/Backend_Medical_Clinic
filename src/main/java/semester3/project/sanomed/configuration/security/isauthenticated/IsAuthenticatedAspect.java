package semester3.project.sanomed.configuration.security.isauthenticated;
...
public class IsAuthenticatedAspect {
    ...
    @Pointcut("@annotation(semester3.project.sanomed.configuration.security.isauthenticated.IsAuthenticated)")
        public void annotatedMethod() {
    }

    @Pointcut("@within(semester3.project.sanomed.configuration.security.isauthenticated.IsAuthenticated)")
