...
class GetTopFiveEmployeesForTheMonthUseCaseImplTest {
    @Mock
    private EmployeeRepository employeeRepository;

    @InjectMocks
    GetTopFiveEmployeesForTheMonthUseCaseImpl getTopFiveEmployeesForTheMonthUseCase;
    ...
    void getStatistics() {
        ...
        when(employeeRepository.getTheTopFiveMostByAppointmentAndTheMonth()).thenReturn(results);
        ...
        List<GeneralStatisticsResponse> actual = getTopFiveEmployeesForTheMonthUseCase.getStatistics();
